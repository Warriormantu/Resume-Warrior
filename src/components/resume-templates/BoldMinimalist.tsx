...
export function BoldMinimalist({ data }: { data: ResumeData }) {
    ...
    return (
        <div className="font-sans text-gray-800 p-8 break-words leading-relaxed">
                ...
                {experience.map(exp => (
                    <div key={exp.id} className="mb-4">
                        <div className="grid grid-cols-[1fr_auto] items-start gap-x-2">
                             ...
                             <p className="text-xs text-gray-500 whitespace-nowrap pt-1 text-right">{exp.startDate} - {exp.isCurrent ? 'Present' : exp.endDate}</p>
                        </div>
                ...
                {education.map(edu => (
                     <div key={edu.id} className="mb-2">
                        <div className="grid grid-cols-[1fr_auto] items-start gap-x-2">
                           ...
                           <p className="text-xs text-gray-500 whitespace-nowrap pt-1 text-right">{edu.startDate} - {edu.endDate}</p>
                        </div>
