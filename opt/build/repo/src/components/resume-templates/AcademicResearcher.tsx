                ...
                {education.map(edu => (
                     <div key={edu.id} className="mb-2">
                        <div className="grid grid-cols-[1fr_auto] items-baseline gap-x-4">
                           ...
                           <p className="text-xs text-gray-600 whitespace-nowrap">{edu.startDate} - {edu.endDate}</p>
                        </div>
                ...
                {experience.map(exp => (
                    <div key={exp.id} className="mb-3">
                        <div className="grid grid-cols-[1fr_auto] items-baseline gap-x-4">
                             ...
                             <p className="text-xs text-gray-600 whitespace-nowrap">{exp.startDate} - {exp.isCurrent ? 'Present' : exp.endDate}</p>
                        </div>
